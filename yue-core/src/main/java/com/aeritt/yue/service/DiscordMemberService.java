...
import com.aeritt.yue.api.service.member.CacheEntry;
...
@Service
public class DiscordMemberService implements com.aeritt.yue.api.service.member.DiscordMemberService {
	...
	@Autowired
	public DiscordMemberService(Logger logger, @Lazy Guild guild) {
		this.logger = logger;
		this.guild = guild;
	}
